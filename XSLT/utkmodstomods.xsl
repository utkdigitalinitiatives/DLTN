<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="pRole">
        ...
        <l string="Creator">Videographer</l>
        <l string="Contributor">Addressee</l>
        <l string="Contributor">Arranger</l>
        <l string="Contributor">Associated name</l>
        <l string="Contributor">Attributed name</l>
        <l string="Contributor">Autographer</l>
        <l string="Contributor">Choreographer</l>
        ...
        <l string="Contributor">Costume designer</l>
        <l string="Contributor">Dedicatee</l>
        <l string="Contributor">Depicted</l>
        ...
        <l string="Contributor">Instrumentalist</l>
        <l string="Contributor">Interviewer</l>
        <l string="Contributor">Issuing body</l>
        <l string="Contributor">Music copyist</l>
